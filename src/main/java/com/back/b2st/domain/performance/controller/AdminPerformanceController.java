...
public class AdminPerformanceController {
	...
	@Operation(
		summary = "공연 목록 조회",
		description = "모든 공연 목록을 Cursor 기반으로 조회합니다. 상태(ACTIVE/ENDED)와 무관하게 조회됩니다. cursor는 마지막으로 조회한 공연 ID입니다."
	)
	@GetMapping
	...
	@Operation(
		summary = "공연 검색",
		description = "키워드로 공연을 Cursor 기반으로 검색합니다. 제목 또는 장르에서 검색됩니다. 키워드가 없으면 전체 목록을 반환합니다."
	)
	@GetMapping("/search")
