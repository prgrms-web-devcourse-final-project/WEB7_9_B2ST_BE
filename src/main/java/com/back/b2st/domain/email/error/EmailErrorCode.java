...
public enum EmailErrorCode implements ErrorCode {
	// 이메일 발송 관련
	EMAIL_SEND_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "E501", "이메일 발송에 실패했습니다. 잠시 후 다시 시도해주세요."),
	// 인증 코드 관련
	...
	VERIFICATION_EXPIRED(HttpStatus.BAD_REQUEST, "E403", "인증 코드가 만료되었습니다. 다시 요청해주세요."),
